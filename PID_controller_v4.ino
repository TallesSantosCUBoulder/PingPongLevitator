...
// PID controller
#include <PID_v1.h> // /home/talles/Arduino/libraries/PID/PID_v1.h // Arduino PID Library - Version 1.1.1 by Brett Beauregard
double iKp=50.0, iKi=5.0, iKd=5.0; // reference_var=20, [0:255]
...
void setup() {
  ...
  height_PID.SetOutputLimits(0, 255);
